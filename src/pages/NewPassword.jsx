...
export default function NewPassword() {
  ...
  return (
    <>
      <h1 className="text-sky-600 font-black text-5xl capitalize">reestablece tu password y no pierdas acceso a tus {' '} <span className="text-slate-700">Viajes</span> </h1>
